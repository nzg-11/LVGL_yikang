...
#define LV_USE_FS_WIN32 1
    ...
    #define LV_FS_WIN32_PATH "/gitlab/lvgl_8.3/lv_port_pc_vscode-main (2)/lv_port_pc_vscode-main/lvgl/eques_lvgl/assets/"         /*Set the working directory. File/directory paths will be appended to it.*/
